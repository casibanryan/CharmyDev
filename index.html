          ...
          >
            <div class="col-auto d-none d-lg-block">
              <div class="header-links">
                <ul>
                  <li>
                    <i class="fas fa-map-location"></i>54 NJ-12, Flemington,
                    United States
                  </li>
                  <li>
            ...
            <div class="row align-items-center justify-content-between">
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="home-it-solution-op.html"
                                >IT Solution Onepage</a
                              >
                            </li>
                            <li>
                              <a href="home-web-agency-op.html"
                                >Web Agency Onepage</a
                              >
                            </li>
                            <li>
                              <a href="home-startup-op.html"
                                >Home Startup Onepage</a
                              >
                            </li>
                            <li>
                              <a href="home-game-solution-op.html"
              ...
              <div class="col-auto d-none d-lg-block">
                <div class="header-button">
                  ...
                  <a href="contact.html" class="th-btn shadow-none"
    ...
    <div class="th-hero-wrapper hero-1" id="hero">
      ...
      <div class="container">
        <div class="hero-style1">
          ...
          <h1 class="hero-title">
            For Smart <span class="text-theme fw-medium">IT Solution</span>
          </h1>
          <p class="hero-text">
          ...
          <div class="btn-group">
            <a href="about.html" class="th-btn"
              >ABOUT US<i class="fa-regular fa-arrow-right ms-2"></i
            ></a>
            <div class="call-btn">
              <a
          ...
          <div class="col-xl-4 col-md-6">
            <div class="feature-card">
              ...
              <p class="feature-card_text">
                Intrinsicly maximize best-of-breed strategic theme areas whereas
                premium alignments. Collaboratively transition client.
              </p>
            </div>
          </div>
          <div class="col-xl-4 col-md-6">
        ...
        <div class="row align-items-center flex-row-reverse">
          ...
          <div class="col-lg-6 text-lg-start text-center">
            ...
            <p class="mt-n2 mb-30">
              ...
              seamless collaboration. Quickly leverage existing 24/7 portals via
              scalable alignments.
            </p>
            <div class="two-column mb-40 list-center">
              <div class="checklist style2">
                <ul>
                  <li>
                    <img src="assets/img/icon/check_1.png" alt="icon" /> Big
                    Data Analysis
                  </li>
                  <li>
      ...
      <div class="round-container gr-bg4 space">
        <div class="container">
          ...
          >
            ...
            <div class="col-auto">
              <div class="sec-btn">
                <a href="project.html" class="th-btn"
                  >VIEW ALL PORJECTS<i
                ...
                <div class="swiper-slide">
                  <div class="project-box">
                    ...
                    >
                      <div class="media-body">
                        <h3 class="box-title">
                          <a href="project-details.html">IT Consultency</a>
                        </h3>
                        <p class="project-subtitle">Technology</p>
                      </div>
                      <a
                        href="assets/img/project/project_3_1.jpg"
                ...
                <div class="swiper-slide">
                  <div class="project-box">
                    ...
                    >
                      ...
                      <a
                        href="assets/img/project/project_3_2.jpg"
                        class="icon-btn popup-image"
                        ><i class="far fa-plus"></i
                      ></a>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="project-box">
                    ...
                    >
                      ...
                      <a
                        href="assets/img/project/project_3_3.jpg"
                        class="icon-btn popup-image"
                        ><i class="far fa-plus"></i
                      ></a>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="project-box">
                    ...
                    >
                      ...
                      <a
                        href="assets/img/project/project_3_4.jpg"
                        class="icon-btn popup-image"
                        ><i class="far fa-plus"></i
                      ></a>
                    </div>
      ...
      <div class="round-container" data-bg-src="assets/img/bg/testi_bg_4.jpg">
        <div class="container">
          <div class="testi-block-area">
            <div
              class="swiper th-slider has-shadow testi-block-slide"
              ...
              <div class="swiper-slide">
                <div class="blog-card">
                  ...
                  <div class="blog-content">
                    <div class="blog-meta">
                      <a href="blog.html"
                        ><i class="fal fa-calendar-days"></i>15 Jan, 2024</a
                      >
                      <a href="blog.html"
              ...
              <div class="swiper-slide">
                <div class="blog-card">
                  ...
                  <div class="blog-content">
                    <div class="blog-meta">
                      <a href="blog.html"
                        ><i class="fal fa-calendar-days"></i>17 Jan, 2024</a
                      >
                      <a href="blog.html"
                        ><i class="fal fa-comments"></i>2 Comments</a
                      >
              ...
              <div class="swiper-slide">
                <div class="blog-card">
                  ...
                  <div class="blog-content">
                    <div class="blog-meta">
                      <a href="blog.html"
                        ><i class="fal fa-calendar-days"></i>19 Jan, 2024</a
                      >
                      <a href="blog.html"
                  ...
                  <div class="recent-post">
                    ...
                    <div class="media-body">
                      ...
                      <div class="recent-post-meta">
                        <a href="blog.html"
                          ><i class="fal fa-calendar-days"></i>21 June, 2024</a
                        >
                      </div>
                    </div>
                  </div>
